◇ injected env (18) from .env.map // tip: ⌁ auth for agents [www.vestauth.com]
◇ injected env (10) from .env.secret // tip: ◈ secrets for agents [www.dotenvx.com]
◇ injected env (0) from .env.local // tip: ⌘ custom filepath { path: '/custom/path/.env' }
Loaded Prisma config from prisma.config.ts.

-- DropIndex
DROP INDEX "idx_file_metadata_user_id";

-- DropIndex
DROP INDEX "idx_processing_jobs_user_id";

-- AlterTable
ALTER TABLE "file_metadata" DROP COLUMN "user_id",
...
ALTER COLUMN "forks" SET DEFAULT 0;

-- DropTable
DROP TABLE "chunk_snapshot";
