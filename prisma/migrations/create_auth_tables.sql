...
CREATE INDEX IF NOT EXISTS "database_connections_owner_id_idx" ON "database_connections"("owner_id");
CREATE INDEX IF NOT EXISTS "database_connections_connected_user_id_idx" ON "database_connections"("connected_user_id");
CREATE UNIQUE INDEX IF NOT EXISTS "database_connections_owner_id_connected_user_id_key" ON "database_connections"("owner_id", "connected_user_id");
...
CREATE UNIQUE INDEX IF NOT EXISTS "token_blacklist_token_jti_key" ON "token_blacklist"("token_jti");
CREATE INDEX IF NOT EXISTS "token_blacklist_token_jti_idx" ON "token_blacklist"("token_jti");
...
CREATE INDEX IF NOT EXISTS "knowledge_bases_workspace_id_idx" ON "knowledge_bases"("workspace_id");
